...
MODULE_PATH = OUT_DIR / "libprovekit_py_v0.py"
...
def _diff_record(
    *,
    ...
    if is_stub:
        ...
        responsible = (
            "provekit-realize-python-core emitted its fallback stub because "
        ...
        responsible = (
            "provekit-lift-python-source emitted python:* body terms rather than "
