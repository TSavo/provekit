# libprovekit self-bind inventory

This directory records the first `provekit bind` run over libprovekit's own Rust source.
Target crate: `libprovekit`.
Source root: `implementations/rust/libprovekit/src/`.
