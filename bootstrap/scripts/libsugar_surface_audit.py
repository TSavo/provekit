#!/usr/bin/env python3
"""Audit libsugar Rust functions through sugar-walk term emission.

The original D1 audit artifacts are not present in this worktree. This driver
walks the libsugar Rust surface, invokes the real sugar-walk term emitter
...
def default_surface(root: Path) -> list[Path]:
    base = root / "implementations" / "rust" / "libsugar"
