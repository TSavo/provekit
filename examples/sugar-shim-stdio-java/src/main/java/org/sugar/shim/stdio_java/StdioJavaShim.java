...
//
// sugar-shim-stdio-java: java.io's @ProveKitSugar shim.
//
// Realizes stdio line-stream concepts via the JDK standard library
// (System.in / System.out / System.err). Sister shim to:
//   - rust: sugar-shim-stdio-rust (std::io)
//   - python: sugar-shim-stdio-python (sys.stdin / sys.stdout)
// All members of concept:family:stdio-stream, anchored to
// boundary:stdio-line-stream.
//
// Substrate-honest concept naming: the 1:1 alignment with sugar-shim-stdio-rust
...
package org.sugar.shim.stdio_java;
 ...
 * sugar-shim-stdio-rust 1:1 where the substrate cluster membership applies.
 */
public final class StdioJavaShim {
     ...
     * <p>
     * Mirrors {@code sugar-shim-stdio-rust::stdin_read_line} which returns
     ...
     * a newline. Mirrors {@code sugar-shim-stdio-rust::stdout_write_line}.
     */
    @ProveKitSugar(
     ...
     * a newline. Mirrors {@code sugar-shim-stdio-rust::stderr_write_line}.
     */
    @ProveKitSugar(
