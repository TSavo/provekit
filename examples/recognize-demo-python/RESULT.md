...
- `fetch_event_response` matches `provekit-shim-python-requests.request`.
- `fetch_event_status` matches `provekit-shim-python-requests.get_status`.
- `connect_db` matches `provekit-shim-python-sqlite3.open_db`.
- `execute_sql` matches `provekit-shim-python-sqlite3.execute`.
- `query_one` matches `provekit-shim-python-sqlite3.query_row`.
...
```
$ PATH=/Users/tsavo/provekit-demo-py/implementations/rust/target/release:$PATH provekit recognize \
    --surface python-bind \
    --target python \
    --project /Users/tsavo/provekit-demo-py/examples/recognize-demo-python \
    ...
    --binding /Users/tsavo/provekit-demo-py/examples/provekit-shim-python-requests/blake3-512:5c59c1475312c3b1afb94c225fd70479da5f439eecf20aae4fb4401989bc17b7f7d895119c9ea8720865e50110cbe8742bde32510ff425d15fe75bd83bd8c9c8.proof \
    --binding /Users/tsavo/provekit-demo-py/examples/provekit-shim-python-sqlite3/blake3-512:619a91986dbd98e8a3a3c12fc4a43c20f529d77a3973f1a5f6e7a92295b0b408070c140af8402c8734a61262c48fc7651fbda822d61c0e709061c3037df0f975.proof
...
recognize: 5 tag(s) emitted
  ...
  [3] concept:sql-execute @ src/recognize_demo_python/persist.py:14 (fn=execute_sql, exact)
  [4] concept:sql-query-row @ src/recognize_demo_python/persist.py:18 (fn=query_one, exact)
write: minted 5 bridge(s) + 5 implication contract(s) into /Users/tsavo/provekit-demo-py/examples/recognize-demo-python/.provekit/recognize/blake3-512:85db159d9d760bf4552886752829af8875a7203e3f630cdf29c80044bb3f14dc0e8d8bb3f3082c4aeb10bc5d99f2190b84a69e93c9882ff414737553680c49ae.proof
```
...
```
$ PATH=/Users/tsavo/provekit-demo-py/implementations/rust/target/release:$PATH provekit prove /Users/tsavo/provekit-demo-py/examples/recognize-demo-python \
    --with /Users/tsavo/provekit-demo-py/examples/provekit-shim-python-requests \
    --with /Users/tsavo/provekit-demo-py/examples/provekit-shim-python-sqlite3

dependency proof resolver ["provekit-bind-lift-python", "--rpc"] does not implement provekit.plugin.resolve_dependency_proofs
