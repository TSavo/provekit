...
//
// sugar-shim-blake3-java: Bouncy Castle's @ProveKitSugar shim.
//
// Realizes concept:family:hash concepts via org.bouncycastle.crypto.digests.Blake3Digest.
// Sister shim to sugar-shim-blake3-rust (crate `blake3`). Both members of
// concept:family:hash; concept names aligned 1:1.

package org.sugar.shim.blake3_java;
...
public final class Blake3Shim {
     ...
     * Mirrors {@code sugar-shim-blake3-rust::blake3_512_of(bytes: &[u8]) -> [u8; 64]}.
     *
