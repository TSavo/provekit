...
//
// sugar-shim-rfc8785-jcs-java: RFC 8785 (JSON Canonicalization Scheme) sugar shim.
//
// Self-contained implementation using Jackson for parsing + manual canonicalization
// per RFC 8785. Sister shim to sugar-shim-rfc8785-jcs-rust on
// concept:family:json-canonicalization. Concept names aligned 1:1.

package org.sugar.shim.rfc8785_jcs_java;
...
public final class RFC8785JcsShim {
     ...
     * {@code sugar-shim-rfc8785-jcs-rust::encode_jcs(v: &Value) -> String}.
     */
    @ProveKitSugar(
        concept = "concept:rfc8785-jcs-encode",
        library = "sugar-rfc8785-jcs-java",
     ...
     * {@code sugar-shim-rfc8785-jcs-rust::encode_value(v: &Value, out: &mut String)}.
     */
    @ProveKitSugar(
     ...
     * Mirrors {@code sugar-shim-rfc8785-jcs-rust::encode_string(s: &str, out: &mut String)}.
     */
    @ProveKitSugar(
