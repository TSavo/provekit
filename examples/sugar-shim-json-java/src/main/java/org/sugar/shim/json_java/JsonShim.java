...
//
// sugar-shim-json-java: Jackson's @ProveKitSugar shim.
//
// Realizes concept:family:json concepts via Jackson (com.fasterxml.jackson.databind).
// Sister shim to:
//   - rust: sugar-shim-serde-json-rust (serde_json)
//   - python: sugar-shim-json-python (stdlib `json`, follow-up)
// All anchor to boundary:rfc8259-json.
//
// Substrate-honest concept naming: the 1:1 alignment with
// sugar-shim-serde-json-rust is the cross-library cluster signal.

package org.sugar.shim.json_java;
 ...
 * <p>
 * Concept names match sugar-shim-serde-json-rust 1:1 (concept:json-parse,
