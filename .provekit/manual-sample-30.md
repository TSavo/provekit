...
## expressible-now-pending-principle (16 sampled / 285 total)
...
**Audit line:** expressible-now-pending-principle: 10 capabilities cover dirty nodes [arithmetic,assigns,returns,member_access,truthiness,narrows,decides,iterates,calls,binding]; cross/intra=118/24 (83%); no principle fires yet

**Signature columns:** ["arithmetic.lhs_node","arithmetic.node_id","arithmetic.op","arithmetic.result_sort","arithmetic.rhs_node","assigns.assign_kind","assigns.node_id","assigns.rhs_node","assigns.target_node","binding.binding_kind","binding.name","binding.node_id","calls.arg_count","calls.callee_is_async","calls.callee_name","calls.callee_node","calls.is_method_call","calls.node_id","decides.condition_node","decides.consequent_node","decides.decision_kind","decides.node_id","iterates.body_node","iterates.condition_node","iterates.executes_at_least_once","iterates.init_node","iterates.loop_kind","iterates.node_id","iterates.update_node","member_access.computed","member_access.node_id","member_access.object_node","member_access.property_name","narrows.narrowed_type","narrows.narrowing_kind","narrows.node_id","narrows.target_node","returns.exit_kind","returns.node_id","returns.value_node","truthiness.coercion_kind","truthiness.node_id","truthiness.operand_node"]
**Signature kinds:** ["arithmetic.op:-","arithmetic.result_sort:Numeric","assigns.assign_kind:=","binding.binding_kind:var","decides.decision_kind:if","decides.decision_kind:short_circuit_or","iterates.loop_kind:for","iterates.loop_kind:while","narrows.narrowing_kind:literal_eq","returns.exit_kind:return","truthiness.coercion_kind:falsy_default","truthiness.coercion_kind:truthy_test"]
...
## expressible-now-recognized (11 sampled / 114 total)
...
**Audit line:** expressible-now-recognized: principles=[throw-uncaught,variable-staleness] hit at locus

**Matched principles:** ["throw-uncaught","variable-staleness"]
