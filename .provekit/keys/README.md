# ProvekIt Foundation Keys

This directory holds the public half of the ProvekIt Foundation Root
...
attestation from `.provekit/catalog-signatures/v1.1.0.json` at compile
