...
public class ClrLifterTests
{
    ...
    public void LiftPathsKeepsSameNamedNestedTypesUnderDifferentDeclaringTypes()
    {
        ...
        Assert.Contains(lifted.Contracts, contract =>
            contract.Name.StartsWith("clr:Provekit.Lift.CLR.Tests.OuterA+Inner::Value#", StringComparison.Ordinal));
        Assert.Contains(lifted.Contracts, contract =>
            contract.Name.StartsWith("clr:Provekit.Lift.CLR.Tests.OuterB+Inner::Value#", StringComparison.Ordinal));
    ...
    public void LiftPathsPrefersReleaseProjectOutputOverDebug()
    {
        ...
        try
        {
            ...
            Assert.Contains(lifted.Contracts, contract =>
                contract.Name.StartsWith("clr:Provekit.Lift.CLR.Tests.ClrFixture::AddOne#", StringComparison.Ordinal));
            Assert.DoesNotContain(lifted.Contracts, contract =>
                contract.Name.StartsWith("clr:Provekit.Lift.CLR.ClrAssemblyLifter::LiftAssembly#", StringComparison.Ordinal));
        }
        finally
        {
