...
use libprovekit::canonical::{json_jcs, serializable_jcs};
use libprovekit::proofir_bridge::{BridgeError, CatalogIndex, ResolvedTerm};
...
fn resolved_cid(resolved: &ResolvedTerm) -> String {
    ...
    provekit_canonicalizer::blake3_512_of(resolved_jcs.as_bytes())
}
