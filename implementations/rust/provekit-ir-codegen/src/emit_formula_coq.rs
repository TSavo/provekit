        ...
        arms: vec![
                    ...
                    ret(Expr::Match {
                        ...
                        arms: vec![
                            MatchArm {
                                pattern: r#""=""#.into(),
                                guard: None,
                                body: block(vec![expr_stmt(format(
                                    "({} = {})",
                                    vec![raw("args_str[0].clone()"), raw("args_str[1].clone()")],
                                ))]),
                            },
                            MatchArm {
                                pattern: r#"">""#.into(),
                            ...
                            MatchArm {
                                pattern: r#""true""#.into(),
                                guard: None,
                                body: block(vec![expr_stmt(lit_str("True"))]),
                            },
                            MatchArm {
                                pattern: r#""false""#.into(),
                                guard: None,
                                body: block(vec![expr_stmt(lit_str("False"))]),
                            },
                            MatchArm {
                                pattern: "_".into(),
                                guard: None,
            ...
            MatchArm {
                ...
                body: block(vec![
                    ...
                    ret(format(
                        "({})",
                        vec![method(var("ops"), "join", vec![raw(r##"r#" /\ "#"##)])],
                    )),
                ]),
            },
            MatchArm {
            ...
            MatchArm {
                ...
                body: block(vec![
                    ...
                    ret(format(
                        "forall {} : {}, {}",
                        vec![var("name"), var("coq_sort"), var("body_str")],
                    )),
                ]),
            },
            MatchArm {
