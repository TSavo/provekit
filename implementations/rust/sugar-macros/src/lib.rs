...
// `::sugar_macros_rt::__priv::...`. The macro expansion surface is
...
pub fn contract(attr: TokenStream, item: TokenStream) -> TokenStream {
    ...
    let expanded = quote! {
        ...
        fn #builder_ident() -> ::sugar_macros_rt::__priv::sugar_ir_symbolic::ContractDecl {
            ...
            ::sugar_macros_rt::__priv::sugar_ir_symbolic::ContractDecl {
                name: __name,
                pre: __pre,
                post: __post,
                inv: __inv,
        ...
        static #static_ident: ::sugar_macros_rt::__priv::ContractRegistration =
            ::sugar_macros_rt::__priv::ContractRegistration {
                name: #fn_name_str,
                source_path: file!(),
                source_line: line!(),
        ...
        ::sugar_macros_rt::__priv::inventory::submit! {
            ::sugar_macros_rt::__priv::ContractRegistration {
                name: #fn_name_str,
                source_path: file!(),
                source_line: line!(),
...
pub fn implement(attr: TokenStream, item: TokenStream) -> TokenStream {
    ...
    let expanded = quote! {
        ...
        #[doc(hidden)]
        #[allow(non_upper_case_globals, non_snake_case)]
        static #static_ident: ::sugar_macros_rt::__priv::ImplementRegistration =
            ::sugar_macros_rt::__priv::ImplementRegistration {
                fn_name: #fn_name_str,
...
pub fn verify(attr: TokenStream, item: TokenStream) -> TokenStream {
    ...
    let expanded = quote! {
        ...
        #[doc(hidden)]
        #[allow(non_upper_case_globals, non_snake_case)]
        static #static_ident: ::sugar_macros_rt::__priv::VerifyTarget =
            ::sugar_macros_rt::__priv::VerifyTarget {
                fn_name: #fn_name_str,
                source_path: file!(),
                source_line: line!(),
