use provekit_ir_symbolic::{ConstValue, Formula, Term};
use provekit_lift_rust_tests::lift_file;

fn parse(src: &str) -> syn::File {
    syn::parse_file(src).expect("fixture parses")
}

fn inv_operands(decl: &provekit_ir_symbolic::ContractDecl) -> &[std::rc::Rc<Formula>] {
