...
// Per #372 part 1.
//
// The Locus DATA type lives in libprovekit (so it can be reused by every
...
// a libprovekit Locus. Keeping the constructor here avoids pulling syn
// into libprovekit while keeping walk-internal call sites unchanged.

pub use libprovekit::compose::Locus;
