...
/// Currently: v1.6.6 (patch bump over v1.6.5: WITHDRAWS the
/// agent-plugin-protocol draft extension — the coding-agent seam
/// (provekit-agent crates + must/fix/agent subcommands + lift --agent)
/// is removed. No core verifier behavior, ProofIR grammar,
/// canonicalization, proof-file format, all-layer lift output, or
/// cross-kit conformance changes).
pub const EXPECTED_CATALOG_CID: &str =
    "blake3-512:809ed1ebd538f206beb9df6de712f502fbcd310ee52d76c34afecec6455259d49cd7d288eb761d5aac9ebbd3643ae4dfe09bc9c7f2aea23e57720df6085c6640";
...
/// `.provekit/catalog-signatures/v1.6.6.json` (current). The v1.6.5,
/// v1.6.4, v1.6.3, v1.6.2, v1.6.1, v1.6.0, v1.5.0, v1.4.1, v1.4.0, v1.3.1, v1.3.0, v1.2.0, and v1.1.0 attestations remain on-disk and as
...
pub const EMBEDDED_CATALOG_SIGNATURE: &[u8] =
    include_bytes!("../assets/catalog-signature-v1.6.6.json");
