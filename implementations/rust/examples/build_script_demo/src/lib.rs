...
//
// This crate's `build.rs` invokes `sugar_build::run_verification()`,
...
use sugar_ir_symbolic::{forall, gte, num, out, Int};
...
// (see `sugar_build::source_walk::CallSite::surrounding_eq_check`)
