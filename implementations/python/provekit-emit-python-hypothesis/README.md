# provekit-emit-python-hypothesis
...
`.provekit/config.toml` registration, the `.provekit/emit/python-hypothesis`
...
```
cd implementations/python/provekit-emit-python-hypothesis
python3 -m pytest
```
