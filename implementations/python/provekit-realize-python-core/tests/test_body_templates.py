...
# ---------------------------------------------------------------------------
# `.proof`-load-via-RPC (PIECE 1, fan-out off canonical-bodies JSON).
#
# Mirrors SugarRealizer.entries() (Java PR #1458): when cmd_materialize lifts
# the shim's signed binding entries and feeds them over RPC, the realize kit
