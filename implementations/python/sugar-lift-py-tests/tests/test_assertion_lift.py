...
imports and applies the EXTERNALIZED `.sugar/vocab-exceptions/<module>.json`
...
EXC_DIR = (os.path.join(WORKSPACE, ".sugar", "vocab-exceptions"),)


def _drop_workspace(tmp_path, module, exception):
    d = tmp_path / ".sugar" / "vocab-exceptions"
