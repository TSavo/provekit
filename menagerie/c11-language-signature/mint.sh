...
for spec in eq_seq_assoc.spec.json eq_seq_skip_left.spec.json eq_seq_skip_right.spec.json eq_if_true.spec.json eq_if_false.spec.json eq_if_idemp.spec.json eq_while_false.spec.json eq_for_desugar.spec.json eq_and_false.spec.json eq_and_true.spec.json eq_and_to_ite_desugar.spec.json eq_or_true.spec.json eq_or_false.spec.json eq_or_to_ite_desugar.spec.json eq_not_not.spec.json eff_eq_read_after_write.spec.json; do
