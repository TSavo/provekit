...
for spec in op_skip.spec.json op_seq.spec.json op_if.spec.json op_while.spec.json op_for.spec.json op_switch.spec.json op_call.spec.json op_return.spec.json op_break.spec.json op_continue.spec.json op_deref.spec.json op_member.spec.json op_add.spec.json op_sub.spec.json op_mul.spec.json op_eq.spec.json op_lt.spec.json op_le.spec.json op_and.spec.json op_or.spec.json op_not.spec.json op_assign.spec.json op_neg.spec.json op_opaque.spec.json op_decl.spec.json op_case.spec.json op_default.spec.json op_label.spec.json op_goto.spec.json op_do.spec.json op_cast.spec.json op_array_subscript.spec.json op_conditional.spec.json op_compound_literal.spec.json op_init_list.spec.json op_string_literal.spec.json op_char_literal.spec.json op_float_literal.spec.json op_imaginary_literal.spec.json op_null.spec.json op_generic_selection.spec.json op_stmt_expr.spec.json op_addr_label.spec.json op_div.spec.json op_mod.spec.json op_shl.spec.json op_shr.spec.json op_bit_and.spec.json op_bit_or.spec.json op_bit_xor.spec.json op_gt.spec.json op_ge.spec.json op_ne.spec.json op_comma.spec.json op_bit_not.spec.json op_addr_of.spec.json op_pre_inc.spec.json op_post_inc.spec.json op_pre_dec.spec.json op_post_dec.spec.json op_plus.spec.json op_unexposed_stmt.spec.json op_unexposed_expr.spec.json op_binary_operator.spec.json op_unary_operator.spec.json eff_op_read.spec.json eff_op_write.spec.json eff_op_input.spec.json eff_op_output.spec.json eff_op_trap.spec.json; do
