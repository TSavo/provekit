...
Date: 2026-05-18
Status: Active. Implemented in libprovekit/src/core/bind.rs via PR #1205.
...
- `project_provekit_transport_architecture` memory
- `project_provekit_three_key_composition` memory (k'' lift, k' transport, k abstraction)
