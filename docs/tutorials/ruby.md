...
> **Status:** kit shipping in the current v1.6.3 tree. Lift adapters shipping: `active_model`, `dry-validation`, `rspec`. LSP plugin shipping. Verification via the Rust CLI. Requires Ruby 3+ (uses endless-method syntax).
