...
This documentation describes protocol catalog v1.4.0, CID `blake3-512:b0f2030d...` (full CID in [`reference/cids.md`](reference/cids.md)). v1.4.0 is additive over v1.3.1 and v1.1.0 mementos remain valid. Verify your local install conforms via `provekit verify-protocol`. For protocol governance, version transitions, and conformance claims, see [governance/](governance/).
