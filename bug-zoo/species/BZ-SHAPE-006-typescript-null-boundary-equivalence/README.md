...
2. Run the zoo verifier, which asks the lifter RPC for canonical ProofIR and
   checks the byte-identical CID against the other TypeScript exposure and the
   Java/C# null-boundary witnesses:

   ```bash
   provekit zoo bug-zoo/species/BZ-SHAPE-006-typescript-null-boundary-equivalence
   ```
