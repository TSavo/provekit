...
name that obligation by CID; and accept a repair only after the repaired
artifact re-lifts to a closed proof graph?
...
proved which source surfaces express it, and, where a dropper exists, accepted
generated code only after re-lift proved the edge was closed.
...
Proofless dropping is allowed only when specimen policy marks it as degraded
evidence.
...
|---|---|---|---|
| `BZ-SHAPE-005` | Java: ProvekIt native annotations, Spring Web | `maybe_null(name) => non_null(name)` | `blake3-512:0d611d8478a205ff040e7d0bcf6c21b12051340ecc5f00c3953af632b23fc01e069b4ad8a8699869163e135b9fde85792eba6acc54cd75cb3d3cc6a40a99ded4` |
| `BZ-SHAPE-006` | TypeScript: zod, class-validator | `maybe_null(name) => non_null(name)` | `blake3-512:0d611d8478a205ff040e7d0bcf6c21b12051340ecc5f00c3953af632b23fc01e069b4ad8a8699869163e135b9fde85792eba6acc54cd75cb3d3cc6a40a99ded4` |
| `BZ-SHAPE-007` | C#: DataAnnotations, `//provekit:` annotations, LINQ | `maybe_null(name) => non_null(name)` | `blake3-512:0d611d8478a205ff040e7d0bcf6c21b12051340ecc5f00c3953af632b23fc01e069b4ad8a8699869163e135b9fde85792eba6acc54cd75cb3d3cc6a40a99ded4` |
