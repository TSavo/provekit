...
require "java_mint_uses_checked_in_java_double_registration"
...
require "java_production_path_uses_checked_in_java_double_registration"
...
require "java_production_path_checked_in_fixture_refuses_planted_contradictory_implication"
