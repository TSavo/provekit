...
/*
 * Snapshot of enum CXCursorKind from libclang 22.1.4 clang-c/Index.h.
 * Updating this snapshot is deliberate: it changes the generated C11
 * cursor-kind signature surface and may change the signature CID.
 */
